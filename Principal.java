...
//        }
        ...
        MinhaData Atual = new MinhaData(13,1,2022);
        DataComemorativa Natal = new DataComemorativa("Natal",true,true,25,12);
        System.out.println(Atual.Compara(Natal.toString(Atual)));
        DatasComemorativas Feriados = new DatasComemorativas();
        Feriados.adiciona(Natal);
        System.out.println("Nao trabalha-se por " + Feriados.horasNaoTrabalhadas() + "horas.");
    }
}
